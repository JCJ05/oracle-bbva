...
public class PUTAR083ImplTest {
	 ...
	 *
	 *  @InjectMocks
	 *  private PUTAR083Impl putaR083 = new PUTAR083Impl() {
	 *  	@Override
	...
	public void executeTest(){
		...
		putaR083.execute();
		Assert.assertEquals(0, putaR083.getAdviceList().size());
	}
}
